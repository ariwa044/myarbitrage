...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Store the referral code they used during signup (if provided)
            signup_ref_code = form.cleaned_data.get('referral_code', '')
            if signup_ref_code:
                user.signup_referral_code = signup_ref_code
            # refferal_code is auto-generated by ShortUUIDField
            user.save()
